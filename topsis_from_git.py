...
evaluation_matrix = df[s]
print(evaluation_matrix)
weights = [0.9562257771816697, 0.004658615461521892, 0.006622882052830922, 0.014558077425207414, 0.011194144227160082, 0.00674050365161004]
...
'''
criterias = np.array([True, False, False, False, True, False])

t = Topsis(evaluation_matrix, weights, criterias)

t.calc()
bd = pd.DataFrame(t.best_similarity)
bd.to_csv('best_dis.csv')
